            ...
            <Route path="/reset-password" element={<ResetPassword />} />
             ...
             <Route path="/app" element={<ProtectedRoute><AppShell /></ProtectedRoute>}>
              ...
              <Route path="materiais" element={<ProtectedRoute roles={["admin","gestor","supervisor","financeiro","auditor"]}><MateriaisEstoque /></ProtectedRoute>} />
               <Route path="estoque" element={<ProtectedRoute roles={["admin","gestor","supervisor","financeiro","auditor","campo","estoque"]}><Estoque defaultTab="overview" /></ProtectedRoute>} />
               <Route path="estoque/materiais" element={<ProtectedRoute roles={["admin","gestor","supervisor","financeiro","auditor","campo","estoque"]}><Estoque defaultTab="materials" /></ProtectedRoute>} />
               <Route path="estoque/almoxarifados" element={<ProtectedRoute roles={["admin","gestor","supervisor","financeiro","auditor","campo","estoque"]}><Estoque defaultTab="warehouses" /></ProtectedRoute>} />
